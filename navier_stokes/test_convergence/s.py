...
for it,n in enumerate(Ns):
    ...
    #p_0 = sin(x*y)
    u_0 = as_vector([-sin(2*pi*y)**3*cos(2*pi*y)*sin(2*pi*x)**4,sin(2*pi*x)**3*cos(2*pi*x)*sin(2*pi*y)**4])
    u_1 = as_vector([-sin(2*pi*y)**3*cos(2*pi*y)*sin(2*pi*x)**4,sin(2*pi*x)**3*cos(2*pi*x)*sin(2*pi*y)**4])
