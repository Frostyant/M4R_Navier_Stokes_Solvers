...
problem = rins.rinsp(mesh,u_0,W,x,y,viscosity = 0.024,BcIds = (1,5), DbcIds = (1,3,4,5),InflowBc = (1,), AdvectionSwitchStep = 0.25,AverageVelocity = AverageVelocity,LengthScale = 1)
